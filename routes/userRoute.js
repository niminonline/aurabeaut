...
userRoute.get("/checkout",isUserSession, stockCheck,orderController.loadCheckout);
...
userRoute.post("/place-order",isUserSession, stockCheck,orderController.placeOrder);
